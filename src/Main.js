...
const irma       = new Irma();
const toCode     = Bytes2Code.toCode.bind(Bytes2Code, irma);
//
// Creates global objects to have an access to app from browser's console
//
window.irma  = {
    code: toCode,       // Converter of bytecode to human readable code
    app : irma,         // Instance of Irma. You may use it to access VM, organisms list and so on...
